...
class VideoPlayerValueUpdated {
  /// Constructs a video with the given values. Only [duration] is required. The
  /// rest will initialize with default values when unset.
  VideoPlayerValueUpdated({
  ...
  VideoPlayerValueUpdated.uninitialized() : this(duration: null);

  /// Returns an instance with a `null` [Duration] and the given
  /// [errorDescription].
  VideoPlayerValueUpdated.erroneous(String errorDescription)
  ...
  VideoPlayerValueUpdated copyWith({
    Duration? duration,
    Size? size,
    Duration? position,
    ...
    return VideoPlayerValueUpdated(
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValueUpdated> {
  ...
  }) : super(VideoPlayerValueUpdated(duration: null)) {
    if (autoCreate) {
      _create();
    }
  }
  ...
  Future<void> dispose() async {
    ...
    if (!_isDisposed) {
      _isDisposed = true;
      value = VideoPlayerValueUpdated.uninitialized();
      _timer?.cancel();
  ...
  /// [VideoPlayerValueUpdated.isLooping].
...
class ClosedCaption extends StatelessWidget {
  ...
  /// [VideoPlayerValueUpdated.caption].
  ///
