...
abstract class BetterPlayerControlsState<T extends StatefulWidget>
  ...
  VideoPlayerValueUpdated? get latestValue;

  bool controlsNotVisible = true;

  void cancelAndRestartTimer();

  bool isVideoFinished(VideoPlayerValueUpdated? VideoPlayerValueUpdated) {
    return VideoPlayerValueUpdated?.position != null &&
        VideoPlayerValueUpdated?.duration != null &&
        VideoPlayerValueUpdated!.position.inMilliseconds != 0 &&
        VideoPlayerValueUpdated.duration!.inMilliseconds != 0 &&
        VideoPlayerValueUpdated.position >= VideoPlayerValueUpdated.duration!;
  }
  ...
  bool isLoading(VideoPlayerValueUpdated? latestValue) {
    if (latestValue != null) {
